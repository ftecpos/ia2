...
echo '<table border="0">';
echo '<tr><th style="width: 150px">入貨日期</th><th style="width: 120px">單號</th><th style="width: 450px">產品名稱</th><th style="width: 50px">數量</th><th bg="yellow" style="width: 80px">入貨金額</th><th style="width: 80px">總金額</th><th style="width: 300px">供應商編號</th><th style="width: 100px">倉庫位置</th><th style="width: 100px">開單員工</th><th style="width: 120px">PO No.</th></tr>';
