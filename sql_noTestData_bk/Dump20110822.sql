...
CREATE TABLE `invoice` (
  ...
  KEY `invoice_fk_invoice` (`invoice_no`),
  ...
  CONSTRAINT `invoice_fk_invoice` FOREIGN KEY (`invoice_no`) REFERENCES `invoice` (`invoice_no`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `invoicedetail` (
  ...
  CONSTRAINT `ind_fk_phone` FOREIGN KEY (`IEME`) REFERENCES `phone` (`IEME`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phone` (
  ...
  CONSTRAINT `phone_fk_phoneState` FOREIGN KEY (`phoneState_no`) REFERENCES `phonestate` (`phoneState_no`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE `phonestate` (
  `phoneState_no` smallint(4) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `po` VALUES (1,'2011-08-07',1,1,1,1);
...
INSERT INTO `podetail` VALUES (3,30,10,1,1,NULL);
...
INSERT INTO `staff` VALUES (1,'rootpass','n/a','root','n/a',1,1);
...
INSERT INTO `supplier` VALUES (1,'TCF company','n/a','n/a','n/a','n/a');
...
CREATE TABLE `transdetail` (
  ...
  CONSTRAINT `td_fk_phone` FOREIGN KEY (`IEME`) REFERENCES `phone` (`IEME`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
-- Dump completed on 2011-08-22  0:25:51
