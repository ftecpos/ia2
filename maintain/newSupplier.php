...
<form name="writing" method="post">
   <table width="1335" height="10" border="0">
	   <tr>
	     ...
	     <td>
		   <input type="text" name="sAddr" maxlength="255" size="125" id="sAddr" onKeyUp="check_a()">
		   <input name="sAddrm" type="text" id="sAddrm" style=" border: none ; color:#FF0000" value="" size="1" readonly></td>
	   </tr><tr>
  ...
  <input type = "button" name = "inPut" id="inPut" value = "新增" onClick="submit_new_suppli()" disabled/>
  <input type = "reset" name = "reset" id="reset11" value = "重設" /><span id = "uploadM"></span>
</form>
</body>
</html>