...
<div id="si_head">
		<input type="button" value="Reset" class="finIncel"  onclick="call_sales_report_detail()" style="height:23;"/>
		...
		<select name="stockin_filter" onchange="change_filter($(this).val())">
			...
			<?php session_start();
				if($_SESSION['retail_no']==1)
					echo '<option value="5">分店</option>'
			?>
			<option value="3">分類</option>
			<option value="4">產品編號</option>
			<option value="9">開單員工</option>
			<option value="10">單據種類</option>
		</select>
...
<div class="" style="margin: 40px 0 0 0;">
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">銷售報表 - 明細</a> <span class="ui-icon ui-icon-close">Remove Tab</span></li>
		</ul>
		<div id="tabs-1">
			<p></p>
		</div>
