...
<div id="si_head">
		<input type="button" value="Reset" class="finIncel"  onclick="call_stock_report_overview()" style="height:23;"/>
    	<label for="stockin_filter" class="gg">Filter : </label>
		<select name="stockin_filter" onchange="change_filter($(this).val())">
			<option value="11" selected="selected">日期</option>
			<option value="5">分店</option>
		...
		<input type="button" value="Search" class="finIncel"  onclick="filter_but(11)" style="height:23;"/></div>
</div>	
...
<div class="" style="margin: 40px 0 0 0;">
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">庫存報表 - 總覧</a> <span class="ui-icon ui-icon-close">Remove Tab</span></li>
		</ul>
		<div id="tabs-1">
			<p></p>
		</div>
