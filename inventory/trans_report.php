...
<div id="si_head">
		<input type="button" value="Reset" class="finIncel"  onclick="call_trans_report()" style="height:23;"/>
...
<div class="" style="margin: 40px 0 0 0;">
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">貨物轉倉報表</a> <span class="ui-icon ui-icon-close">Remove Tab</span></li>
		</ul>
		<div id="tabs-1">
			<p></p>
		</div>
