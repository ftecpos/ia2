<?php 
	...
	echo '<tr><td width="700"><div align="right">換貨總額 :</div></td>';
	...
	switch($payment_method){
		case"1":
			echo '<td width="100"><div align="left">Cash-in</div></td>';
			echo '<td width="100" id="total"><div align="right">$HKD '.$paid.'</div></td></tr>';
			break;
		case"2":
			echo '<td width="100"><div align="left">EPS</div></td>';
			echo '<td width="100" id="total"><div align="right">$HKD '.$paid.'</div></td></tr>';
			break;
		case"3":
			echo '<td width="100"><div align="left">信用卡</div></td>';
			echo '<td width="100" id="total"><div align="right">$HKD '.$paid.'</div></td></tr>';
			break;
		case"4":
			echo '<td width="100"><div align="left">八逹通</div></td>';
			echo '<td width="100" id="total"><div align="right">$HKD '.$paid.'</div></td></tr>';
			break;
	}
	echo "</table>";
